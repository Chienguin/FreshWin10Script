...
# Single Command Source: https://github.com/ChrisTitusTech/win10script
#
...
#
#     > powershell -nop -c "iex(New-Object Net.WebClient).DownloadString('https://git.io/JJz3i')"
#
...
$tweaks = @(
	...
	"InstallDefaultProgs", #REQUIRED FOR OTHER PROGRAM INSTALLS!
	"InstallAdobe",
	"Install7Zip",
	"InstallGoogleChrome",
        "InstallVLC",
...
#########
# Recommended Default Programs
#########

Function InstallDefaultProgs {
	...
	Start-BitsTransfer -Source "https://raw.githubusercontent.com/Chienguin/FreshWin10Script/master/ooshutup10.cfg" -Destination ooshutup10.cfg
